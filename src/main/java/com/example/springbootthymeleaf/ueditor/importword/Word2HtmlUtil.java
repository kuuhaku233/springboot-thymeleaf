...
public class Word2HtmlUtil {
    ...
    /**
     * @param file       word文件
     * @param folderPath Word文档中的图片保存地址
     * @param webPath    用于web显示的地址
     * @return
     * @throws IOException
     */
    ...
    /**
     * @param data     Word文档
     * @param fileType Word文档类型 doc|docx
     * @return
     */
       ...
       /* NodeList imgs = document.getElementsByTagName("img");
        for (int i = 0; i < imgs.getLength(); i++) {
            ...
            if (!isDoc) {
                String src = item.getAttribute("src");
                String imgPath = picMap.get(src);
                String hzm = src.substring(src.lastIndexOf("."));
                String savePath = "D:/ueditor/test/" + UUID.randomUUID().toString() + hzm;
                MultipartFile file = base64ToMultipart(imgPath, savePath);
                try{
    ...
    /**
     *   解析文档图片 支持 base64格式的解析
     * @param xwpfDocument 文档的参数
     * @throws Exception
     */
...
//				picMap.put(imgKey,  pic64);
     ...
     * @param savePath  存储路径
     * @return fase/true  失败/成功
     */
	public static MultipartFile base64ToMultipart(String base64, String savePath) {
		try {
			...
			return new Base64Util(b, baseStrs[0], savePath);
		} catch (IOException e) {
			e.printStackTrace();
			return null;
		}
   ...
   /* public static void main(String[] args) throws Exception {
        File file = new File("D:/新建 Microsoft Word 文档.docx");
        File file1 = new File("D:/新建 Microsoft Word 文档.html");
        File file2 = new File("D:/testDOC.doc");
        File file3 = new File("D:/testDOC.html");
